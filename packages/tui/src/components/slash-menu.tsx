        ...
        {(cmd, i) => {
          ...
          return (
            <box backgroundColor={ironRainTheme.chrome.bg} width="100%">
              <text
                fg={isSelected() ? ironRainTheme.brand.primary : ironRainTheme.chrome.fg}
              >
...
export function getFilteredCommands(filter: string, extraCommands?: SlashCommand[]): SlashCommand[] {
  const all = extraCommands ? [...SLASH_COMMANDS, ...extraCommands] : SLASH_COMMANDS;
